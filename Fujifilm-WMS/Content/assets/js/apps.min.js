    ...
    handlePanelAction = function () {
        ...
        panelActionRunning = !0, $(document).on("hover", "[data-click=panel-remove]", function (e) {
            ...
            e.preventDefault(), $(this).closest(".panel").find(".panel-body").slideToggle({
                complete: function () {
                    if (CUI.dataTableID != "") CUI.setDatatableMaxHeight();
                    if ($("#tableContainer").length) handsontableResizer();
                }
            }).toggleClass("tago");
    ...
    function a(e, a) {
        ...
        switch ($(t).find("li").each(function () {
            ...
            case "next":
                ...
                }, 150)) : l = i - o - 80, 0 !== l && ($("body").hasClass("rtl-mode") ? $(t).find(".nav.nav-tabs").animate({
                    marginRight: "-" + l + "px"
                }, 150, function () {
            ...
            case "prev":
                var r;
                l = (r = -o) <= i ? ($(t).removeClass("overflow-left"), 0) : r - i + 80, $("body").hasClass("rtl-mode") ? $(t).find(".nav.nav-tabs").animate({
                    marginRight: "-" + l + "px"
                }, 150, function () {
        ...
        $(".tab-overflow").each(function () {
            ! function (e, a) {
                ...
                if ($(e).find(t).prevAll().each(function () {
                    ...
                    var r = i - o;
                    l != i && (r += 40), $("body").hasClass("rtl-mode") ? $(e).find(".nav.nav-tabs").animate({
                        marginRight: "-" + r + "px"
                    }, s) : $(e).find(".nav.nav-tabs").animate({
                        marginLeft: "-" + r + "px"
                    }, s)
                }
...
handleUnlimitedTopMenuRender = function () {
    ...
    function a(e, a) {
        ...
        switch ($(t).find("li").each(function () {
            ...
            case "next":
                ...
                }, 150)) : l = i - o - 128, 0 !== l && ($("body").hasClass("rtl-mode") ? $(t).animate({
                    marginRight: "-" + l + "px"
                }, 150, function () {
            ...
            case "prev":
                var r;
                l = (r = -o) <= i ? ($(t).find(".menu-control.menu-control-left").removeClass("show"), 0) : r - i + 88, $("body").hasClass("rtl-mode") ? $(t).animate({
                    marginRight: "-" + l + "px"
                }, 150, function () {
    ...
    function e() {
        ...
        if ($(t).prevAll().each(function () {
            ...
            var r = s - i + 128;
            $("body").hasClass("rtl-mode") ? $(e).animate({
                marginRight: "-" + r + "px"
            }, 0) : $(e).animate({
                marginLeft: "-" + r + "px"
            }, 0)
...
handleSidebarMinifyFloatMenu = function () {
    $(document).on("click", "#float-sub-menu li.has-sub > a", function (e) {
    ...
    }), $(".sidebar .nav > li.has-sub > a, .sidebar .nav > li.li-menu > a").hover(function () {
        if ($("#page-container").hasClass("page-sidebar-minified")) {
            ...
            if (e.length == 0) {
                ...
                var mainText = $(this)[0].childNodes[5].innerText;
                main = "<li><a href='#'>" + mainText + "</a></li>";
                a = main + a;
            }
            ...
            if (a) {
                var t = $("#sidebar").offset(),
                    ...
                    r = $(window).height();
                if (0 === $("#float-sub-menu").length ? (a = '<div class="float-sub-menu-container" id="float-sub-menu" \
                                                                    data-offset-top="' + i + '" \
                                                                    data-menu-offset-top="' + i + '" \
                                                                    onmouseover="handleMouseoverFloatSubMenu(this)" \
                                                                    onmouseout="handleMouseoutFloatSubMenu(this)">\t\
                                                                  <div class="float-sub-menu-arrow" id="float-sub-menu-arrow"></div>\t\
                                                                  <div class="float-sub-menu-line" id="float-sub-menu-line"></div>\t\
                                                                        <ul class="float-sub-menu">'+ a + "</ul>\
                                                                  </div>", $("#page-container").append(a)) : ($("#float-sub-menu").attr("data-offset-top", i), $("#float-sub-menu").attr("data-menu-offset-top", i), $(".float-sub-menu").html(a)), o < r - i) $("#float-sub-menu").css({
                                                                      top: i,
                                                                      left: s,
                                                                      bottom: "auto",
                                                                      right: l
...
App = function () {
    ...
    return {
        ...
        initComponent: function () {
            (!a || a && !a.disableDraggablePanel) && handleDraggablePanel(), handleIEFullHeightContent(), handleSlimScroll(), handleUnlimitedTabsRender(), handlePanelAction(), handleScrollToTopButton(), handleAfterPageLoadAddClass(), handlePageScrollClass(), 767 < $(window).width() && handelTooltipPopoverActivation()
        },
